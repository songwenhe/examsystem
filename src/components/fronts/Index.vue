<template>
  <div class="index-container">
    <h1 class="h1">成都东软学院在线考试教学辅助系统</h1>
    <div class="frontpageBtn">
      <router-link class="box" to="contest" routers="contest">
        <i class="el-icon-s-platform iconfont"></i>
        <h4>考试</h4>
        <p>即使是正规的教学考试，也能轻松应对，准确评判</p>
      </router-link>
      <router-link class="box" to="subject" routers="subject">
        <i class="el-icon-s-order iconfont"></i>
        <h4>题库</h4>
        <p>适合教学使用的题目，合理的题目分类</p>
      </router-link>
      <router-link class="box" to="shares" routers="shares">
