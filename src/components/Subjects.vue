      ...
      <el-table :data="tableData" style="width: 90%">
        ...
        <el-table-column label="题目数量" prop="questionNum">
          <template slot-scope="scope">
            <div slot="reference" class="name-wrapper" v-if="scope.row.questionNum === 1">
              <el-tag>未开始</el-tag>
            </div>
            <div slot="reference" class="name-wrapper" v-else-if="scope.row.questionNum === 2">
              <el-tag type="success">进行中</el-tag>
            </div>
            <div slot="reference" class="name-wrapper" v-else-if="scope.row.questionNum === 3">
        ...
        <el-table-column align="right" label="操作">
          <template slot="header" slot-scope="scope">
            ...
            <el-button class="el-icon-search" size="mini" @click="getSubjects" style="position: absolute; top: 0px; right: 10px"></el-button>
          </template>
          <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit(index, row) {
        ...
        this.ruleForm.data1.push(row.creatTime, row.updateTime)
